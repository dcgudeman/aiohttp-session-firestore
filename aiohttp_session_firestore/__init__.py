...
class FirestoreStorage(AbstractStorage):
    ...
    By default, new session document IDs are generated by Firestore itself
    (well-distributed, 20-character alphanumeric).  Supply a custom
    ...
    key_factory:
        ...
        Defaults to ``None``, which lets Firestore auto-generate IDs.
    ...
    def _generate_key(self) -> str:
        ...
        delegates to Firestore's auto-generated document ID.
        """
        if self._key_factory is not None:
            return self._key_factory()
        key: str = self._collection.document().id
        return key
